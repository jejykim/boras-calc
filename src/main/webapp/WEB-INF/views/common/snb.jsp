    ...
    <div class="menu">
        ...
        <ul>
            ...
            <li class="mainmenu">
                ...
                <div class="submenu">
                    <ul>
                        <li <%=uri.contains("/") ? "class='on'" : "" %>><a href="/"><i class="fa fa-file-code-o" aria-hidden="true"></i><span>금융사별 부가세 설정</span></a></li>
                        <li <%=uri.contains("/") ? "class='on'" : "" %>><a href="/"><i class="fa fa-file-code-o" aria-hidden="true"></i><span>계출 공식 설정</span></a></li>
